...
class AudioGenerator:
    ...
    def generate_chapter_chunked(
        ...
        if use_dsl:
            ...
            # No DSL, use normal paragraph splitting
        ...
        # Join paragraphs back into text for chunking (preserves existing behavior)
        text_for_chunking = '\n\n'.join(paragraphs)
        # Get chunks with positions for metadata tracking
        ...
        try:
            ...
            tracker.update_chunk_count(chapter_title, len(audio_files))
